...
<c:choose>
    <c:when test="${sessionScope.type=='student'}">
        <div>
            <span>欢迎来到<span class="um_span">学生管理系统</span>这里选着转到</span>
    ...
    <c:when test="${sessionScope.type=='teacher'}">
        <div>
            <span>欢迎来到<span class="um_span">老师管理系统</span>这里选着转到</span>
    ...
    <c:otherwise>
        <div>
            <span>欢迎来到<span class="um_span">管理系统</span>这里选着转到</span>
